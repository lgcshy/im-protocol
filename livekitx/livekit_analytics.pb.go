...
type AnalyticsVideoLayer struct {
	...
	TotalPackets uint32 `protobuf:"varint,2,opt,name=total_packets,json=totalPackets,proto3" json:"total_packets,omitempty"`
	TotalBytes   uint64 `protobuf:"varint,3,opt,name=total_bytes,json=totalBytes,proto3" json:"total_bytes,omitempty"`
	TotalFrames  uint32 `protobuf:"varint,4,opt,name=total_frames,json=totalFrames,proto3" json:"total_frames,omitempty"`
}
...
func (x *AnalyticsVideoLayer) GetTotalPackets() uint32 {
	if x != nil {
...
func (x *AnalyticsVideoLayer) GetTotalBytes() uint64 {
	if x != nil {
		return x.TotalBytes
	}
	return 0
...
func (x *AnalyticsVideoLayer) GetTotalFrames() uint32 {
	if x != nil {
...
type AnalyticsStream struct {
	...
	TotalPrimaryPackets    uint32                 `protobuf:"varint,2,opt,name=total_primary_packets,json=totalPrimaryPackets,proto3" json:"total_primary_packets,omitempty"`
	TotalPrimaryBytes      uint64                 `protobuf:"varint,3,opt,name=total_primary_bytes,json=totalPrimaryBytes,proto3" json:"total_primary_bytes,omitempty"`
	TotalRetransmitPackets uint32                 `protobuf:"varint,4,opt,name=total_retransmit_packets,json=totalRetransmitPackets,proto3" json:"total_retransmit_packets,omitempty"`
	TotalRetransmitBytes   uint64                 `protobuf:"varint,5,opt,name=total_retransmit_bytes,json=totalRetransmitBytes,proto3" json:"total_retransmit_bytes,omitempty"`
	TotalPaddingPackets    uint32                 `protobuf:"varint,6,opt,name=total_padding_packets,json=totalPaddingPackets,proto3" json:"total_padding_packets,omitempty"`
	TotalPaddingBytes      uint64                 `protobuf:"varint,7,opt,name=total_padding_bytes,json=totalPaddingBytes,proto3" json:"total_padding_bytes,omitempty"`
	TotalPacketsLost       uint32                 `protobuf:"varint,8,opt,name=total_packets_lost,json=totalPacketsLost,proto3" json:"total_packets_lost,omitempty"`
	TotalFrames            uint32                 `protobuf:"varint,9,opt,name=total_frames,json=totalFrames,proto3" json:"total_frames,omitempty"`
	...
	TotalNacks             uint32                 `protobuf:"varint,12,opt,name=total_nacks,json=totalNacks,proto3" json:"total_nacks,omitempty"`
	TotalPlis              uint32                 `protobuf:"varint,13,opt,name=total_plis,json=totalPlis,proto3" json:"total_plis,omitempty"`
	TotalFirs              uint32                 `protobuf:"varint,14,opt,name=total_firs,json=totalFirs,proto3" json:"total_firs,omitempty"`
...
func (x *AnalyticsStream) GetTotalPrimaryPackets() uint32 {
	if x != nil {
		return x.TotalPrimaryPackets
	}
	return 0
}

func (x *AnalyticsStream) GetTotalPrimaryBytes() uint64 {
	if x != nil {
		return x.TotalPrimaryBytes
	}
	return 0
}

func (x *AnalyticsStream) GetTotalRetransmitPackets() uint32 {
	if x != nil {
		return x.TotalRetransmitPackets
	}
	return 0
}

func (x *AnalyticsStream) GetTotalRetransmitBytes() uint64 {
	if x != nil {
		return x.TotalRetransmitBytes
	}
	return 0
}

func (x *AnalyticsStream) GetTotalPaddingPackets() uint32 {
	if x != nil {
		return x.TotalPaddingPackets
	}
	return 0
}

func (x *AnalyticsStream) GetTotalPaddingBytes() uint64 {
	if x != nil {
		return x.TotalPaddingBytes
	}
	return 0
}

func (x *AnalyticsStream) GetTotalPacketsLost() uint32 {
	if x != nil {
		return x.TotalPacketsLost
	}
	return 0
}

func (x *AnalyticsStream) GetTotalFrames() uint32 {
	if x != nil {
		return x.TotalFrames
	}
	return 0
...
func (x *AnalyticsStream) GetTotalNacks() uint32 {
	if x != nil {
		return x.TotalNacks
	}
	return 0
...
func (x *AnalyticsStream) GetTotalPlis() uint32 {
	if x != nil {
		return x.TotalPlis
	}
	return 0
...
func (x *AnalyticsStream) GetTotalFirs() uint32 {
	if x != nil {
		return x.TotalFirs
	}
	return 0
...
type AnalyticsStat struct {
	...
	Kind          StreamType             `protobuf:"varint,2,opt,name=kind,proto3,enum=livekitx.StreamType" json:"kind,omitempty"`
...
type AnalyticsEvent struct {
	...
	Type          AnalyticsEventType     `protobuf:"varint,1,opt,name=type,proto3,enum=livekitx.AnalyticsEventType" json:"type,omitempty"`
...
var file_livekit_analytics_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x41, 0x64,
	0x64, 0x72, 0x12, 0x2e, 0x0a, 0x13, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x5f, 0x63, 0x6f, 0x6e,
	0x6e, 0x65, 0x63, 0x74, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x11, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x54, 0x69,
	0x6d, 0x65, 0x22, 0xa2, 0x04, 0x0a, 0x0e, 0x41, 0x6e, 0x61, 0x6c, 0x79, 0x74, 0x69, 0x63, 0x73,
	0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x30, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x1c, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69, 0x74, 0x78, 0x2e, 0x41,
	...
	0x28, 0x09, 0x52, 0x06, 0x72, 0x6f, 0x6f, 0x6d, 0x49, 0x64, 0x12, 0x22, 0x0a, 0x04, 0x72, 0x6f,
	0x6f, 0x6d, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x6b,
	0x69, 0x74, 0x78, 0x2e, 0x52, 0x6f, 0x6f, 0x6d, 0x52, 0x04, 0x72, 0x6f, 0x6f, 0x6d, 0x12, 0x25,
	...
	0x61, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x3b, 0x0a, 0x0b, 0x70, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69,
	0x70, 0x61, 0x6e, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x6c, 0x69, 0x76,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x49, 0x64, 0x12, 0x29, 0x0a,
	0x05, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x6c,
	0x69, 0x76, 0x65, 0x6b, 0x69, 0x74, 0x78, 0x2e, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x49, 0x6e, 0x66,
	0x6f, 0x52, 0x05, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x12, 0x21, 0x0a, 0x0c, 0x72, 0x65, 0x63, 0x6f,
	0x72, 0x64, 0x69, 0x6e, 0x67, 0x5f, 0x69, 0x64, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b,
	0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x49, 0x64, 0x12, 0x23, 0x0a, 0x0d, 0x61,
	...
	,
	...
	0x53, 0x54, 0x52, 0x45, 0x41, 0x4d, 0x10, 0x01, 0x2a, 0x9e, 0x02, 0x0a, 0x12, 0x41, 0x6e, 0x61,
	...
	,
	...
	0x2f, 0x6c, 0x67, 0x63, 0x73, 0x68, 0x79, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c,
	0x2f, 0x6c, 0x69, 0x76, 0x65, 0x6b, 0x69, 0x74, 0x78, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_livekit_analytics_proto_goTypes = []interface{}{
	(StreamType)(0),               // 0: livekitx.StreamType
	(AnalyticsEventType)(0),       // 1: livekitx.AnalyticsEventType
	(*AnalyticsVideoLayer)(nil),   // 2: livekitx.AnalyticsVideoLayer
	(*AnalyticsStream)(nil),       // 3: livekitx.AnalyticsStream
	(*AnalyticsStat)(nil),         // 4: livekitx.AnalyticsStat
	(*AnalyticsStats)(nil),        // 5: livekitx.AnalyticsStats
	(*AnalyticsClientMeta)(nil),   // 6: livekitx.AnalyticsClientMeta
	(*AnalyticsEvent)(nil),        // 7: livekitx.AnalyticsEvent
	(*AnalyticsEvents)(nil),       // 8: livekitx.AnalyticsEvents
	(*timestamppb.Timestamp)(nil), // 9: google.protobuf.Timestamp
	(*Room)(nil),                  // 10: livekitx.Room
	(*ParticipantInfo)(nil),       // 11: livekitx.ParticipantInfo
	(*TrackInfo)(nil),             // 12: livekitx.TrackInfo
	(*ClientInfo)(nil),            // 13: livekitx.ClientInfo
	(*emptypb.Empty)(nil),         // 14: google.protobuf.Empty
}
var file_livekit_analytics_proto_depIdxs = []int32{
	2,  // 0: livekitx.AnalyticsStream.video_layers:type_name -> livekitx.AnalyticsVideoLayer
	0,  // 1: livekitx.AnalyticsStat.kind:type_name -> livekitx.StreamType
	9,  // 2: livekitx.AnalyticsStat.time_stamp:type_name -> google.protobuf.Timestamp
	3,  // 3: livekitx.AnalyticsStat.streams:type_name -> livekitx.AnalyticsStream
	4,  // 4: livekitx.AnalyticsStats.stats:type_name -> livekitx.AnalyticsStat
	1,  // 5: livekitx.AnalyticsEvent.type:type_name -> livekitx.AnalyticsEventType
	9,  // 6: livekitx.AnalyticsEvent.timestamp:type_name -> google.protobuf.Timestamp
	10, // 7: livekitx.AnalyticsEvent.room:type_name -> livekitx.Room
	11, // 8: livekitx.AnalyticsEvent.participant:type_name -> livekitx.ParticipantInfo
	12, // 9: livekitx.AnalyticsEvent.track:type_name -> livekitx.TrackInfo
	13, // 10: livekitx.AnalyticsEvent.client_info:type_name -> livekitx.ClientInfo
	6,  // 11: livekitx.AnalyticsEvent.client_meta:type_name -> livekitx.AnalyticsClientMeta
	7,  // 12: livekitx.AnalyticsEvents.events:type_name -> livekitx.AnalyticsEvent
	5,  // 13: livekitx.AnalyticsRecorderService.IngestStats:input_type -> livekitx.AnalyticsStats
	8,  // 14: livekitx.AnalyticsRecorderService.IngestEvents:input_type -> livekitx.AnalyticsEvents
	14, // 15: livekitx.AnalyticsRecorderService.IngestStats:output_type -> google.protobuf.Empty
	14, // 16: livekitx.AnalyticsRecorderService.IngestEvents:output_type -> google.protobuf.Empty
